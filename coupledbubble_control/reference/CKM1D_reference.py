...
def setup(ac_field, k, num_bubbles, linsolve: str = "bicg"):
    ...
    def _jacobi(r_delta, s, mx, G, H, b, atol=1e-10, rtol=1e-10, maxiter=100):
        ...
        for k in range(maxiter):
            #print("Av", _AxV(r_delta, s, mx, G, H, x))
            #input()
            r = b - _AxV(r_delta, s, mx, G, H, x)
            #print("r", r)
            rnorm = np.linalg.norm(r)
            #print("rnorm", rnorm)
            #print("rnorm^2", rnorm**2)
            #input()
            if rnorm <= tol:
                print(k)
                return x, 1
    ...
    def _explicit_coupling(r_delta, s, mx, G, H):
        ...
        #print(-2.5 * ((coupling_matrix * s) @ H[2]))
...
if __name__ == "__main__":
    ...
    multi_bubbles.x0[1] = 200 * 1e-6 / LR
    #multi_bubbles.x0[2] = 10000 * 1e-6 / LR
    #multi_bubbles.x0[3] = 10300 * 1e-6 / LR
    #print(multi_bubbles.mx[0])
    #print(multi_bubbles.mx[1])
    #print(multi_bubbles.mx[2])
